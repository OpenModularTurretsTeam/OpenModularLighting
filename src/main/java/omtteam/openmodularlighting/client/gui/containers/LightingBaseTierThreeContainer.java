...
public class LightingBaseTierThreeContainer extends LightingBaseContainer {
    public LightingBaseTierThreeContainer(InventoryPlayer inventoryPlayer, LightingBase te) {
        this.tileEntity = te;
