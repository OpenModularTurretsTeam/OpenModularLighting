...
public class LightingBaseTierFiveContainer extends LightingBaseContainer {
    public LightingBaseTierFiveContainer(InventoryPlayer inventoryPlayer, LightingBase te) {
        this.tileEntity = te;
        ...
        addSlotToContainer(new UpgradeSlot(tileEntity, 3, 92, 52));
    }
}