...
import omtteam.openmodularlighting.client.gui.containers.LightingBaseTierOneContainer;
...
public class LightingBaseTierOneGUI extends LightingBaseAbstractGUI {
    public LightingBaseTierOneGUI(InventoryPlayer inventoryPlayer, LightingBase tileEntity) {
        super(inventoryPlayer, tileEntity, new LightingBaseTierOneContainer(inventoryPlayer, tileEntity));
    }

    @Override
    protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
        ResourceLocation texture = (new ResourceLocation(OMLNames.Textures.lightingBaseTierOneGUI));
