...
import omtteam.openmodularlighting.client.gui.containers.LightingBaseTierThreeContainer;
...
public class LightingBaseTierThreeGUI extends LightingBaseAbstractGUI {
    public LightingBaseTierThreeGUI(InventoryPlayer inventoryPlayer, LightingBase tileEntity) {
        super(inventoryPlayer, tileEntity, new LightingBaseTierThreeContainer(inventoryPlayer, tileEntity));
    }

    @Override
    protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
        // draw your Gui here, only thing you need to change is the path
        ResourceLocation texture = (new ResourceLocation(OMLNames.Textures.lightingBaseTierThreeGUI));
