...
import omtteam.openmodularlighting.client.gui.containers.LightingBaseTierFourContainer;
...
public class LightingBaseTierFourGUI extends LightingBaseAbstractGUI {
    public LightingBaseTierFourGUI(InventoryPlayer inventoryPlayer, LightingBase tileEntity) {
        super(inventoryPlayer, tileEntity, new LightingBaseTierFourContainer(inventoryPlayer, tileEntity));
    }

    @Override
    protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
        ResourceLocation texture = (new ResourceLocation(OMLNames.Textures.lightingBaseTierFourGUI));
