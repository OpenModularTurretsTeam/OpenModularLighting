...
import omtteam.openmodularlighting.client.gui.containers.LightingBaseTierFiveContainer;
...
public class LightingBaseTierFiveGUI extends LightingBaseAbstractGUI {
    public LightingBaseTierFiveGUI(InventoryPlayer inventoryPlayer, LightingBase tileEntity) {
        super(inventoryPlayer, tileEntity, new LightingBaseTierFiveContainer(inventoryPlayer, tileEntity));
    }

    @Override
    protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
        ResourceLocation texture = (new ResourceLocation(OMLNames.Textures.lightingBaseTierFiveGUI));
