 ...
 * This Class
 */
public class OMLFakePlayer {
    private static final GameProfile profile = new GameProfile(UUID.fromString("e8bbb077-dffe-4368-bb49-45938920a445"), "openmodularlighting:fakeplayer");
