...
public class WailaLightingBaseHandler implements IWailaDataProvider {
    /**
    ...
    static void callbackRegister(IWailaRegistrar register) {
        WailaLightingBaseHandler instance = new WailaLightingBaseHandler();

        register.registerNBTProvider(instance, LightingBase.class);
        register.registerBodyProvider(instance, LightingBase.class);
    }
